...
for iter in $ITERS; do
    ...
    python train.py --show --loss hungarian --dim 512 --dataset clevr-state --epochs 100 --latent 512 --supervised --resume logs/$MODEL --iters $iter --name test --eval-only --export-dir $OUTPATH --full-eval $ARGS --mask-feature
